        ...
        for (String certNumber : certs) {
            ...
            try {
                ...
                if ("pkcs12".equals(type)) {
                    ...
                    List<Certificate> cc = CertificateUtils
                            .readCertificatesOfKeystore(new FileInputStream(new File(filePath)), passwordks);
                ...
                if (debug == true) {
                    ...
                    System.out
                            .println("Emissior Name: " + CertificateUtils.getCN(certificate1.getIssuerDN().toString()));

                }

                /* XYZ ZZZ */
                System.out.println("Subject getSimpleName: " + CertificateUtils.getSubjectCorrectName(certificate1));
                ...
                System.out.println("Emissor: " + CertificateUtils.getCN(certificate1.getIssuerDN().toString()));
