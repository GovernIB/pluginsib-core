...
public class MetadataConstants {
  ...
  public static final MetadataConstant _ENI_APP_TRAMITE_DOC = new MetadataConstant(
      ENI_APP_TRAMITE_DOC, MetadataType.STRING,
      "Código de la aplicación de trámite que generó el documento.");
  ...
  public static final MetadataConstant _ENI_APP_TRAMITE_EXP = new MetadataConstant(
      ENI_APP_TRAMITE_EXP, MetadataType.STRING,
      "Código de la aplicación de trámite que generó el expediente.");
  ...
  public static final MetadataConstant _ENI_PERFIL_FIRMA = new MetadataConstant(
      ENI_PERFIL_FIRMA, MetadataType.STRING,
  ...
  public static final MetadataConstant _ENI_FECHA_SELLADO = new MetadataConstant(
  ...
  public static final MetadataConstant _ENI_ID = new MetadataConstant(ENI_ID,
      ...
      "(ES_" + _ENI_ORGANO.getPatternRegEx() + "_\\d{4}_EXP_.{30})|(ES_"
          + _ENI_ORGANO.getPatternRegEx() + "_\\d{4}_.{30})");
  ...
  public static final MetadataConstant _ENI_VERSION_NTI = new MetadataConstant(ENI_VERSION_NTI,
      ...
      new HashMap<String, String>() {
        {
          put("http://administracionelectronica.gob.es/ENI/XSD/v1.0/expediente-e",
              "Para expediente");
          put("http://administracionelectronica.gob.es/ENI/XSD/v1.0/documento-e",
              "Para documento");
        }
      });
  ...
  public static final MetadataConstant _ENI_ESTADO_ELABORACION = new MetadataConstant(
  ...
  public static final MetadataConstant _ENI_FECHA_INICIO = new MetadataConstant(
      ENI_FECHA_INICIO, MetadataType.DATE,
  ...
  public static final MetadataConstant _ENI_NOMBRE_FORMATO = new MetadataConstant(
      ENI_NOMBRE_FORMATO, MetadataType.STRING,
      "Denominación del formato lógico"
  ...
  public static final MetadataConstant _ENI_DEF_CSV = new MetadataConstant(ENI_DEF_CSV,
      MetadataType.STRING,
  ...
  public static final MetadataConstant _ENI_ESTADO_EXP = new MetadataConstant(ENI_ESTADO_EXP,
      MetadataType.STRING,
      ...
      new HashMap<String, String>() {
        {
          ...
          put("E02", "Cerrado");
          put("E03",
              "Índice para remisión cerrado, exclusivo para subexpedientes de intercambio");
        }
      });
  ...
  public static final MetadataConstant _ENI_DESCRIPCION = new MetadataConstant(ENI_DESCRIPCION,
      MetadataType.STRING, "Información adicional sobre el documento o expediente.");
  ...
  public static final MetadataConstant _ENI_SOPORTE = new MetadataConstant(ENI_SOPORTE,
      MetadataType.STRING, "Objeto físico donde se almacena un expediente o documento",
      new HashMap<String, String>() {
        {
          put("Digital", "Digital");
          put("CD-ROM", "CD-ROM");
  ...
  public static final MetadataConstant _ENI_UNIDADES = new MetadataConstant(ENI_UNIDADES,
      MetadataType.STRING,
  ...
  public static final MetadataConstant _ENI_SUBTIPO_DOC = new MetadataConstant(ENI_SUBTIPO_DOC,
      MetadataType.STRING,
      "Tipo documental específico establecido por los procedimientos del Govern.");
  ...
  public static final MetadataConstant _ENI_TIPO_ASIENTO_REGISTRAL = new MetadataConstant(
      ENI_TIPO_ASIENTO_REGISTRAL, MetadataType.INTEGER, "Tipo de asiento registral",
      new HashMap<String, String>() {
        {
  ...
  public static final MetadataConstant _ENI_ESTADO_ARCHIVO = new MetadataConstant(
      ENI_ESTADO_ARCHIVO, MetadataType.STRING, "Tipo de asiento registral",
      new HashMap<String, String>() {
        {
  ...
  public static final MetadataConstant _ENI_CATEGORIA = new MetadataConstant(ENI_CATEGORIA,
      MetadataType.STRING, "Tipo de entidad que se está describiendo",
      new HashMap<String, String>() {
        {
          put("Serie", "Serie");
  ...
  public static final MetadataConstant _ENI_LOPD = new MetadataConstant(ENI_LOPD,
      MetadataType.STRING, "Clasificación de sensibilidad LOPD",
      new HashMap<String, String>() {
        {
          put("Básico", "Básico");
          put("Medio", "Medio");
  ...
  public static final MetadataConstant _ENI_TIPO_ACCESO = new MetadataConstant(ENI_TIPO_ACCESO,
      MetadataType.STRING,
  ...
  public static final MetadataConstant _ENI_NORMATIVA = new MetadataConstant(ENI_NORMATIVA,
      MetadataType.STRING,
  ...
  public static final MetadataConstant _ENI_FECHA_FIN_EXP = new MetadataConstant(
      ENI_FECHA_FIN_EXP, MetadataType.DATE,
      "Fecha en que se considera finalizado el expediente");
  ...
  public static final MetadataConstant _ENI_COND_REUTILIZACION = new MetadataConstant(
      ENI_COND_REUTILIZACION, MetadataType.DATE,
      "Indica bajo qué condiciones un expediente o documento de acceso libre es reutilizable."
          + "Usado si tipo_acceso= “Libre”");
  ...
  public static final MetadataConstant _ENI_TIPO_VALOR = new MetadataConstant(ENI_TIPO_VALOR,
      MetadataType.STRING,
  ...
  public static final MetadataConstant _ENI_PLAZO = new MetadataConstant(ENI_PLAZO,
